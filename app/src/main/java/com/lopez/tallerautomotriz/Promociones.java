...
public class Promociones extends Fragment  {
    ...
    private final String url="https://tallerservice.000webhostapp.com/promociones.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myFragmentView=inflater.inflate(R.layout.fragment_promociones, container, false);

        recyclerView = (RecyclerView)myFragmentView.findViewById(R.id.listado);
        bookLoading= (BookLoading)myFragmentView.findViewById(R.id.bookloading);
        bookLoading.start();
        ...
        array=new JsonObjectRequest(Request.Method.GET, url, "", new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                adapter = new RecyclerAdapter(getContext(), getPromociones(response));
    ...
    //metodo para llenar el recycler view desde web services
    private List<Card> getPromociones(JSONObject jsonObject) {
        ...
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                card.setTitulo(object.getString("nombre_promocion"));
